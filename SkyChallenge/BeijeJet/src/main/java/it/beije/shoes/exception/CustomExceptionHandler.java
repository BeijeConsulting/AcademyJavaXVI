...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> ControllerExceptionHandler(InvalidJwtAuthenticationException ex,
			WebRequest request) {
	...
	@ExceptionHandler(value = { ShoesException.class })
	public ResponseEntity<ErrorMessage> ControllerExceptionHandler(ShoesException ex, WebRequest request) {
		int errorCode = 400;
		ErrorMessage re = new ErrorMessage();
		re.setMessage(ex.getLocalizedMessage());
		re.setStatus(errorCode);
