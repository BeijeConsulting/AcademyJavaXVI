...
//	
//	public static List<Speranza> readRubrica(String pathfile) throws FileNotFoundException, IOException {
//		FileReader fileReader = new FileReader(pathfile);
//		BufferedReader bufferedReader = new BufferedReader(fileReader);
//		List<Speranza> contatti = new ArrayList<Speranza>();
//		
//		try {
//			String r = null;
//			String[] fields = null;
//			Speranza contatto = null;
//			while (bufferedReader.ready()) {
//				r = bufferedReader.readLine();
//				fields = r.split(";");
//				
//				contatto = new Speranza();
...
//
//		
//	public static void writeRubrica(String pathfile, List<Speranza> contatti) throws FileNotFoundException, IOException {
//		
//	}
//	public static void main(String[] args) throws FileNotFoundException, IOException {
//		List<Speranza> contatti = readRubrica("/temp/rubrica.csv");
