...
public class LineaDiComando {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
		...
		RubricaInterface rubricaAPI = new RubricaJPACriteria(); //istanziando una classe diversa qui si cambia facilmente da JPA a HBM o JDBC
		...
		while(true) {
			...
			if (input.equals("0")) {
				...
				rubricaAPI.unisciContattiDuplicati();
