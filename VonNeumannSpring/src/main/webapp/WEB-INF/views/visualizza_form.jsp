...
<title>Visualizza form Contatto</title>
</head>
<body>
...
<c:choose>
	<c:when test="${not empty contatto}">
		...
		<form action="./inserisci_contatto" method="post">
		  ...
		  <button type="submit" formmethod="get" formaction="./final_message"> Ok</button> <br/>
		  <input type="reset" value="ANNULLA">
		</form> 
	</c:when>
	<c:otherwise>
		<form action="./visualizza_form" method="post">
